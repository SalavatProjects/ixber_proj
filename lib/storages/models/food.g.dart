...
Food _foodDeserialize(
  ...
  object.protein = reader.readDoubleOrNull(offsets[4]);
  return object;
}
...
extension FoodQueryFilter on QueryBuilder<Food, Food, QFilterCondition> {
  QueryBuilder<Food, Food, QAfterFilterCondition> caloriesIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Food, Food, QAfterFilterCondition> caloriesIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Food, Food, QAfterFilterCondition> caloriesEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
...
extension FoodQueryProperty on QueryBuilder<Food, Food, QQueryProperty> {
  ...
  QueryBuilder<Food, int?, QQueryOperations> caloriesProperty() {
    return QueryBuilder.apply(this, (query) {
